        ...
        >
          <div class="flex flex-col md:flex-row items-center gap-8">
            ...
            <div class="relative">
              ...
              ></div>
              <div
                class="absolute bottom-2 end-2 w-6 h-6 bg-gray-300 rounded-full border-4 border-white animate-pulse"
              ></div>
            </div>
            ...
            <div class="text-center md:text-start flex-1 w-full">
              ...
              <div
                class="flex flex-wrap justify-center md:justify-start gap-4 mb-6"
              >
                <div
              ...
              <div class="flex flex-wrap gap-2 justify-center md:justify-start">
                <div
                  class="h-7 bg-gray-200 rounded-full w-20 animate-pulse"
                ></div>
                <div
