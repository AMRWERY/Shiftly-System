  ...
  <div>
    <ul class="space-y-1">
      ...
      <li>
        ...
        >
          <Icon
            name="material-symbols:contact-phone-rounded"
            class="sidebar-section-icon"
            :class="
              isActive('/contact-details')
                ? 'text-brand-primary dark:text-white'
      ...
      <li>
        ...
        >
          <Icon
            name="material-symbols:pending-actions-rounded"
            class="sidebar-section-icon"
            :class="
              isActive('/request-status')
                ? 'text-brand-primary dark:text-white'
      ...
      <li>
        <nuxt-link-locale
          to="/contract-handbook"
          class="sidebar-nav-link group"
          :class="
            isActive('/contract-handbook')
              ? 'sidebar-link-active'
              : 'sidebar-link-hover text-tx-primary'
          "
        >
      ...
      <li>
        <nuxt-link-locale
          ...
          class="sidebar-nav-link group"
          :class="
            isActive('/clock-in-out')
              ? 'sidebar-link-active'
              : 'sidebar-link-hover text-tx-primary'
          "
        >
          <Icon
            name="material-symbols:fingerprint-rounded"
            class="sidebar-section-icon"
            :class="
              isActive('/clock-in-out')
                ? 'text-brand-primary dark:text-white'
