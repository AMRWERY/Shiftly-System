  ...
  <div>
    <ul class="space-y-1">
      ...
      <li>
        ...
        >
          <Icon
            name="material-symbols:military-tech-rounded"
            class="sidebar-section-icon"
            :class="
              isActive('/certifications')
                ? 'text-brand-primary dark:text-white'
      ...
      <li>
        <nuxt-link-locale
          ...
          class="sidebar-nav-link group"
          :class="
            isActive('/enrollment-requests')
              ? 'sidebar-link-active'
              : 'sidebar-link-hover text-tx-primary'
          "
        >
          <Icon
            name="material-symbols:how-to-reg-rounded"
            class="sidebar-section-icon"
            :class="
              isActive('/enrollment-requests')
                ? 'text-brand-primary dark:text-white'
