    ...
    <div class="p-6">
      ...
      <div class="max-w-4xl mx-auto">
        ...
        <div class="bg-white rounded-xl shadow-lg border border-gray-100 p-8 mb-6">
          <div class="flex flex-col md:flex-row items-center gap-8">
            ...
            <div class="relative">
              ...
              <div class="absolute bottom-2 end-2 w-6 h-6 bg-gray-300 rounded-full border-4 border-white animate-pulse">
              </div>
            </div>

            <div class="text-center md:text-start flex-1 w-full">
              <!-- Name and Date Skeleton -->
              <div class="flex flex-col md:flex-row md:justify-between items-center gap-4 mb-4">
              ...
              <div class="flex flex-wrap gap-2 justify-center md:justify-start">
                <div class="h-7 bg-gray-200 rounded-full w-20 animate-pulse"></div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
          <!-- Employment Details Card Skeleton -->
          <div class="bg-white rounded-xl shadow-lg border border-gray-100 p-6">
            ...
            <!-- Detail Items -->
            <div class="space-y-4">
              <div class="flex justify-between items-center" v-for="i in 3" :key="`emp-${i}`">
          ...
          <div class="bg-white rounded-xl shadow-lg border border-gray-100 p-6">
            ...
            <!-- Detail Items -->
            <div class="space-y-4">
              <div class="flex justify-between items-center" v-for="i in 3" :key="`personal-${i}`">
                <div class="h-4 bg-gray-200 rounded w-24 animate-pulse"></div>
