<template>
    <div>
        <div class="card-bg p-6 flex flex-col h-fit">
            <h3 class="text-tx-primary font-semibold text-lg mb-8">Department Distribution</h3>
            ...
            <div class="relative flex justify-center items-center mb-10">
                ...
                <div class="absolute inset-0 flex flex-col items-center justify-center">
                    <span class="text-3xl font-bold text-tx-primary leading-none">1,248</span>
            ...
            <div class="grid grid-cols-2 gap-y-4 gap-x-2">
                <div v-for="item in data" :key="item.label" class="flex items-center gap-2">
                    ...
                    <span class="text-[11px] text-tx-secondary font-medium">
