<template>
  <div>
    <ul class="space-y-3">
      <li>
        ...
        >
          ...
          <icon
            ...
            class="w-5 h-5"
            :class="{ 'rotate-180': dropdownStates.payroll }"
            aria-hidden="true"
          />
        </button>
      ...
      <li>
        <button
          @click="toggleDropdown('expenses_advances')"
          type="button"
          class="flex items-center w-full p-2 text-base text-white transition duration-75 rounded-lg group"
        >
          <icon
          ...
          <icon
            name="material-symbols:keyboard-arrow-down-rounded"
            class="w-5 h-5"
            :class="{ 'rotate-180': dropdownStates.expenses_advances }"
            aria-hidden="true"
          />
        </button>
      ...
      <li>
        ...
        >
          ...
          <icon
            name="material-symbols:keyboard-arrow-down-rounded"
            class="w-5 h-5"
            :class="{ 'rotate-180': dropdownStates.invoicing }"
            aria-hidden="true"
          />
        </button>
      ...
      <li>
        <button
          @click="toggleDropdown('financial_reports')"
          type="button"
          class="flex items-center w-full p-2 text-base text-white transition duration-75 rounded-lg group"
        >
          <icon
          ...
          <icon
            name="material-symbols:keyboard-arrow-down-rounded"
            class="w-5 h-5"
            :class="{ 'rotate-180': dropdownStates.financial_reports }"
            aria-hidden="true"
          />
        </button>
