  ...
  <div>
    <div class="justify-center">
      <div class="flex flex-col items-center justify-center mt-24">
        <img src="/svg/error-404.svg" alt="error-404" class="emoji-404" />

        <div class="mt-4 tracking-widest text-center">
          <span class="block text-6xl text-gray-500"
            ><span>{{ error.statusCode }}</span></span
          >
          <span class="text-xl text-gray-500">{{
            t("error_page.sorry_we_couldnt_find_what_you_are_looking_for")
          }}</span>
        </div>
