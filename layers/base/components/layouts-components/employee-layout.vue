<template>
  <div>
    <ul class="space-y-3">
      <li>
        <button
          @click="toggleDropdown('my_profile')"
          type="button"
        ...
        >
          ...
          <icon
            ...
            class="w-5 h-5"
            :class="{ 'rotate-180': dropdownStates.my_profile }"
            aria-hidden="true"
          />
        </button>
      ...
      <li>
        <button
          @click="toggleDropdown('my_requests')"
          type="button"
          class="flex items-center w-full p-2 text-base text-white transition duration-75 rounded-lg group"
        >
          <icon
          ...
          <icon
            name="material-symbols:keyboard-arrow-down-rounded"
            class="w-5 h-5"
            :class="{ 'rotate-180': dropdownStates.my_requests }"
            aria-hidden="true"
          />
        </button>
      ...
      <li>
        <button
          @click="toggleDropdown('payroll_docs')"
          type="button"
          class="flex items-center w-full p-2 text-base text-white transition duration-75 rounded-lg group"
        >
          <icon
          ...
          <icon
            name="material-symbols:keyboard-arrow-down-rounded"
            class="w-5 h-5"
            :class="{ 'rotate-180': dropdownStates.payroll_docs }"
            aria-hidden="true"
          />
        </button>
      ...
      <li>
        <button
          @click="toggleDropdown('t_a_my_logs')"
          type="button"
          class="flex items-center w-full p-2 text-base text-white transition duration-75 rounded-lg group"
        >
          <icon
          ...
          <icon
            name="material-symbols:keyboard-arrow-down-rounded"
            class="w-5 h-5"
            :class="{ 'rotate-180': dropdownStates.t_a_my_logs }"
            aria-hidden="true"
          />
        </button>
      ...
      <li>
        <button
          @click="toggleDropdown('company_assets')"
          type="button"
          class="flex items-center w-full p-2 text-base text-white transition duration-75 rounded-lg group"
        >
          <icon
          ...
          <icon
            name="material-symbols:keyboard-arrow-down-rounded"
            class="w-5 h-5"
            :class="{ 'rotate-180': dropdownStates.company_assets }"
            aria-hidden="true"
          />
        </button>
