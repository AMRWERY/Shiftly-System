    ...
    <ul class="space-y-1">
      ...
      <li>
        <nuxt-link-locale
          ...
          class="sidebar-nav-link group"
          :class="
            isActive('/critical-alerts')
              ? 'sidebar-link-active'
              : 'sidebar-link-hover text-tx-primary'
          "
        >
          <Icon
            name="material-symbols:notification-important-rounded"
            class="sidebar-section-icon"
            :class="
              isActive('/critical-alerts')
                ? 'text-brand-primary dark:text-white'
      ...
      <li>
        <nuxt-link-locale
          ...
          class="sidebar-nav-link group"
          :class="
            isActive('/categories-units')
              ? 'sidebar-link-active'
              : 'sidebar-link-hover text-tx-primary'
          "
        >
          <Icon
            name="material-symbols:label-rounded"
            class="sidebar-section-icon"
            :class="
              isActive('/categories-units')
                ? 'text-brand-primary dark:text-white'
      ...
      <li>
        <nuxt-link-locale
          ...
          class="sidebar-nav-link group"
          :class="
            isActive('/batch-expiry-tracking')
              ? 'sidebar-link-active'
              : 'sidebar-link-hover text-tx-primary'
          "
        >
      ...
      <li>
        <nuxt-link-locale
          ...
          class="sidebar-nav-link group"
          :class="
            isActive('/physical-count-records')
              ? 'sidebar-link-active'
              : 'sidebar-link-hover text-tx-primary'
          "
        >
      ...
      <li>
        <nuxt-link-locale
          ...
          class="sidebar-nav-link group"
          :class="
            isActive('/suppliers-master')
              ? 'sidebar-link-active'
              : 'sidebar-link-hover text-tx-primary'
          "
        >
          <Icon
            name="material-symbols:storefront-rounded"
            class="sidebar-section-icon"
            :class="
              isActive('/suppliers-master')
                ? 'text-brand-primary dark:text-white'
