  ...
  <div>
    ...
    <div class="p-6 mt-16">
      <LazyVButton
        ...
        :padding-x="'px-4'"
        :padding-y="'py-2.5'"
        class="flex items-center justify-center rounded-lg transition-colors group"
      ...
      <LazyVDialog
        v-model="showDialog"
        :title="t('dialog.reset_password_title')"
        :message="t('dialog.reset_password_message')"
        :confirm-text="t('btn.confirm')"
      >
        <template #body>
        ...
        <template #footer>
          <LazyVButton
            ...
            :padding-x="'px-4'"
            :padding-y="'py-2.5'"
            class="rounded-lg border-2 transition-colors group"
            @click="handleConfirm"
          >
            {{ t("btn.verify_otp") }}
          </LazyVButton>
