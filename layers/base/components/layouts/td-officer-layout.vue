    ...
    <ul class="space-y-1">
      <li v-if="hasPermission('training', 'view')">
        <nuxt-link-locale to="/course-creation" class="sidebar-nav-link group"
          :class="isActive('/course-creation') ? 'sidebar-link-active' : 'sidebar-link-hover text-tx-primary'">
          <Icon name="material-symbols:add-circle-outline-rounded" class="sidebar-section-icon"
            :class="isActive('/course-creation') ? 'text-brand-primary dark:text-white' : 'text-tx-muted'" />
      ...
      <li v-if="hasPermission('training', 'view')">
        <nuxt-link-locale to="/scheduling" class="sidebar-nav-link group"
          :class="isActive('/scheduling') ? 'sidebar-link-active' : 'sidebar-link-hover text-tx-primary'">
          <Icon name="material-symbols:event-rounded" class="sidebar-section-icon"
            :class="isActive('/scheduling') ? 'text-brand-primary dark:text-white' : 'text-tx-muted'" />
      ...
      <li v-if="hasPermission('training', 'view')">
        <nuxt-link-locale to="/resource-mgt" class="sidebar-nav-link group"
          :class="isActive('/resource-mgt') ? 'sidebar-link-active' : 'sidebar-link-hover text-tx-primary'">
          <Icon name="material-symbols:folder-open-rounded" class="sidebar-section-icon"
            :class="isActive('/resource-mgt') ? 'text-brand-primary dark:text-white' : 'text-tx-muted'" />
      ...
      <li v-if="hasPermission('training', 'view')">
        <nuxt-link-locale to="/training-records" class="sidebar-nav-link group"
          :class="isActive('/training-records') ? 'sidebar-link-active' : 'sidebar-link-hover text-tx-primary'">
          <Icon name="material-symbols:school-rounded" class="sidebar-section-icon"
            :class="isActive('/training-records') ? 'text-brand-primary dark:text-white' : 'text-tx-muted'" />
      ...
      <li v-if="hasPermission('training', 'view')">
        <nuxt-link-locale to="/certifications" class="sidebar-nav-link group"
          :class="isActive('/certifications') ? 'sidebar-link-active' : 'sidebar-link-hover text-tx-primary'">
          <Icon name="material-symbols:military-tech-rounded" class="sidebar-section-icon"
            :class="isActive('/certifications') ? 'text-brand-primary dark:text-white' : 'text-tx-muted'" />
      ...
      <li v-if="hasPermission('training', 'view')">
        <nuxt-link-locale to="/career-path-mapping" class="sidebar-nav-link group"
          :class="isActive('/career-path-mapping') ? 'sidebar-link-active' : 'sidebar-link-hover text-tx-primary'">
          <Icon name="material-symbols:trending-up-rounded" class="sidebar-section-icon"
            :class="isActive('/career-path-mapping') ? 'text-brand-primary dark:text-white' : 'text-tx-muted'" />
      ...
      <li v-if="hasPermission('training', 'approve')">
        <nuxt-link-locale to="/enrollment-requests" class="sidebar-nav-link group"
          :class="isActive('/enrollment-requests') ? 'sidebar-link-active' : 'sidebar-link-hover text-tx-primary'">
          <Icon name="material-symbols:how-to-reg-rounded" class="sidebar-section-icon"
            :class="isActive('/enrollment-requests') ? 'text-brand-primary dark:text-white' : 'text-tx-muted'" />
      ...
      <li v-if="hasPermission('training', 'approve')">
        <nuxt-link-locale to="/budget-approvals" class="sidebar-nav-link group"
          :class="isActive('/budget-approvals') ? 'sidebar-link-active' : 'sidebar-link-hover text-tx-primary'">
          <Icon name="material-symbols:account-balance-wallet-rounded" class="sidebar-section-icon"
            :class="isActive('/budget-approvals') ? 'text-brand-primary dark:text-white' : 'text-tx-muted'" />
      ...
      <li v-if="hasPermission('reports', 'view')">
        <nuxt-link-locale to="/skill-matrix" class="sidebar-nav-link group"
          :class="isActive('/skill-matrix') ? 'sidebar-link-active' : 'sidebar-link-hover text-tx-primary'">
          <Icon name="material-symbols:grid-view-rounded" class="sidebar-section-icon"
            :class="isActive('/skill-matrix') ? 'text-brand-primary dark:text-white' : 'text-tx-muted'" />
      ...
      <li v-if="hasPermission('reports', 'view')">
        <nuxt-link-locale to="/stock-adjustment" class="sidebar-nav-link group"
          :class="isActive('/stock-adjustment') ? 'sidebar-link-active' : 'sidebar-link-hover text-tx-primary'">
          <Icon name="material-symbols:analytics-rounded" class="sidebar-section-icon"
            :class="isActive('/stock-adjustment') ? 'text-brand-primary dark:text-white' : 'text-tx-muted'" />
