<template>
  <div>
    <ul class="space-y-3">
      ...
      <li>
        <button
          @click="toggleDropdown('user_roles_mgt')"
          type="button"
        ...
        >
          ...
          <icon
            ...
            class="w-5 h-5"
            :class="{ 'rotate-180': dropdownStates.user_roles_mgt }"
            aria-hidden="true"
          />
        </button>
      ...
      <li>
        <button
          @click="toggleDropdown('system_settings')"
          type="button"
          class="flex items-center w-full p-2 text-base text-white transition duration-75 rounded-lg group"
        >
          <icon
          ...
          <icon
            name="material-symbols:keyboard-arrow-down-rounded"
            class="w-5 h-5"
            :class="{ 'rotate-180': dropdownStates.system_settings }"
            aria-hidden="true"
          />
        </button>
