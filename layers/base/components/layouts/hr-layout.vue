    ...
    <ul class="space-y-3">
      ...
      <li v-if="hasPermission('attendance', 'view')">
        ...
        <ul v-if="dropdownStates.time_attendance" class="py-2 space-y-2">
          ...
          <li>
            <nuxt-link-locale to="/overtime-penalties" class="flex items-center p-2 rounded-lg group ps-7"
          ...
          <li>
            <nuxt-link-locale to="/shift-management" class="flex items-center p-2 rounded-lg group ps-7"
      ...
      <li v-if="hasPermission('leave', 'view')">
        ...
        <ul v-if="dropdownStates.leave_mgt" class="py-2 space-y-2">
          ...
          <li>
            <nuxt-link-locale to="/leave-balances" class="flex items-center p-2 rounded-lg group ps-7"
          ...
          <li>
            <nuxt-link-locale to="/holiday-calendar" class="flex items-center p-2 rounded-lg group ps-7"
      ...
      <li v-if="hasPermission('performance', 'view')">
        ...
        <ul v-if="dropdownStates.performance" class="py-2 space-y-2">
          ...
          <li>
            <nuxt-link-locale to="/goals-setting-kpis" class="flex items-center p-2 rounded-lg group ps-7"
          ...
          <li>
            <nuxt-link-locale to="/360-feedback" class="flex items-center p-2 rounded-lg group ps-7"
      ...
      <li v-if="hasPermission('assets', 'view')">
        ...
        <ul v-if="dropdownStates.asset_assignment" class="py-2 space-y-2">
          ...
          <li>
            <nuxt-link-locale to="/handover-return-process" class="flex items-center p-2 rounded-lg group ps-7"
      ...
      <li v-if="hasPermission('recruitment', 'view')">
        ...
        <ul v-if="dropdownStates.recruitment" class="py-2 space-y-2">
          ...
          <li>
            <nuxt-link-locale to="/job-openings" class="flex items-center p-2 rounded-lg group ps-7"
          ...
          <li>
            <nuxt-link-locale to="/interview-scheduling" class="flex items-center p-2 rounded-lg group ps-7"
