    ...
    <section class="w-full">
      <div class="flex flex-col">
        ...
        <div class="sm:w-[80%] w-[90%] mx-auto flex">
          ...
          >
            <div class="flex flex-col justify-center">
              <!-- FullName -->
              <h1
                class="text-start text-gray-800 lg:text-4xl md:text-3xl sm:text-3xl text-xl font-bold"
              >
              ...
              <div class="flex items-center gap-3 mt-2">
                <p
                  class="text-start text-gray-700 text-lg font-bold underline capitalize"
                >
        ...
        >
          ...
          <div
            class="w-full max-w-3xl mx-auto space-y-6 bg-white rounded-lg shadow-md p-6 profile-card-bg"
          >
            <div class="space-y-4">
