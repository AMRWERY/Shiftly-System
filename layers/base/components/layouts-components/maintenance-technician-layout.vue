<template>
  <div>
    <ul class="space-y-3">
      <li>
        <button
          @click="toggleDropdown('service_requests')"
          type="button"
        ...
        >
          ...
          <icon
            ...
            class="w-5 h-5"
            :class="{ 'rotate-180': dropdownStates.service_requests }"
            aria-hidden="true"
          />
        </button>
      ...
      <li>
        <button
          @click="toggleDropdown('preventive_maint')"
          type="button"
          class="flex items-center w-full p-2 text-base text-white transition duration-75 rounded-lg group"
        >
          <icon
          ...
          <icon
            name="material-symbols:keyboard-arrow-down-rounded"
            class="w-5 h-5"
            :class="{ 'rotate-180': dropdownStates.preventive_maint }"
            aria-hidden="true"
          />
        </button>
      ...
      <li>
        <button
          @click="toggleDropdown('asset_maintenance_log')"
          type="button"
          class="flex items-center w-full p-2 text-base text-white transition duration-75 rounded-lg group"
        >
          <icon
          ...
          <icon
            name="material-symbols:keyboard-arrow-down-rounded"
            class="w-5 h-5"
            :class="{ 'rotate-180': dropdownStates.asset_maintenance_log }"
            aria-hidden="true"
          />
        </button>
      ...
      <li>
        <button
          @click="toggleDropdown('spare_parts')"
          type="button"
          class="flex items-center w-full p-2 text-base text-white transition duration-75 rounded-lg group"
        >
          <icon
          ...
          <icon
            name="material-symbols:keyboard-arrow-down-rounded"
            class="w-5 h-5"
            :class="{ 'rotate-180': dropdownStates.spare_parts }"
            aria-hidden="true"
          />
        </button>
        <ul v-if="dropdownStates.spare_parts" class="py-2 space-y-2">
          ...
          <li>
            <nuxt-link-locale
              to="/stock-request-from-inventory"
              class="flex items-center p-2 text-white rounded-lg group ps-7"
              active-class="bg-gray-400 text-white hover:bg-gray-500"
              :exact="true"
            >
