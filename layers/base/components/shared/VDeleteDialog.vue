            ...
            <div class="my-6 text-center">
              ...
              <div class="text-center mt-10">
                <button @click="closeModal" type="button"
                  class="px-5 py-2.5 rounded-lg text-white text-sm font-medium bg-gray-700 hover:bg-gray-600 active:bg-gray-700">
                  {{ cancelText }}
                </button>
                <button @click="confirmDelete" type="button"
                  :class="['px-5 py-2.5 rounded-lg text-white text-sm font-medium ms-4', loading ? 'bg-red-400 cursor-not-allowed' : 'bg-red-400 hover:bg-red-500 active:bg-red-400']"
                  :disabled="loading">
