  ...
  <div>
    ...
    <div :class="{ rtl: localeStore.isRTL }">
      <div class="flex h-screen overflow-hidden bg-brand-systemBg select-none">
        ...
        <!-- ───────────────── SIDEBAR (desktop) ───────────────── -->
        <aside
          class="relative flex-shrink-0 hidden lg:flex flex-col bg-brand-layoutBg border-e border-white/5 z-40"
          :class="[isResizing ? '' : 'transition-[width] duration-200 ease-in-out']"
          :style="{ width: `${sidebarWidth}px` }"
        >
          <!-- Logo -->
          <div
            class="flex items-center border-b border-white/5 h-14 px-3 flex-shrink-0 overflow-hidden"
          ...
          >
            ...
            <div v-if="!isCollapsed" class="flex flex-col min-w-0 overflow-hidden">
              <span class="text-white text-sm font-bold leading-tight truncate">Shiftly</span>
              <span class="text-[10px] uppercase tracking-widest text-gray-500 font-medium truncate">
          ...
          <div class="border-t border-white/5 p-3 flex-shrink-0 overflow-hidden">
            ...
            <div v-if="!isCollapsed" class="flex items-center gap-3 mb-2 px-1 py-1">
              <img
                :src="authStore.currentUser?.user_metadata?.avatarUrl || '/img/dummy-profile-img.jpg'"
                alt="avatar"
            ...
            <VButton
              ...
              :padding-x="isCollapsed ? 'px-2' : 'px-2'"
              :padding-y="isCollapsed ? 'py-2' : 'py-1.5'"
              class="rounded-lg hover:text-white text-[13px]"
              @click="handleLogout"
            >
          ...
          >
            <icon
              :name="
                (localeStore.isRTL ? !isCollapsed : isCollapsed)
          ...
          >
            <div class="flex items-center gap-3 border-b border-white/5 h-14 px-4 flex-shrink-0">
              ...
              <div class="flex flex-col min-w-0 flex-1">
                <span class="text-white text-sm font-bold leading-tight">Shiftly</span>
            ...
            <div class="border-t border-white/5 p-3 flex-shrink-0">
              ...
              <VButton
                ...
                padding-x="px-2"
                padding-y="py-1.5"
                class="rounded-lg hover:text-white text-[13px] gap-2"
                @click="handleLogout"
              >
        ...
        <div class="flex-1 flex flex-col overflow-hidden min-w-0">
          <!-- Top header -->
          <header class="h-14 px-4 flex items-center justify-between flex-shrink-0 border-b border-white/5 bg-brand-systemBg/80 backdrop-blur-md z-20">
            <div class="flex items-center gap-3">
              <VButton
                ...
                padding-x="px-1.5"
                padding-y="py-1.5"
                class="lg:hidden rounded-lg hover:text-white"
            ...
            <div class="flex items-center gap-2">
              <VSearchInput v-model="searchQuery" :placeholder="'Search...'" class="hidden md:block w-52" />
              ...
              <VButton
                ...
                padding-x="px-0"
                padding-y="py-0"
                class="w-8 h-8 rounded-lg overflow-hidden ring-1 ring-white/10 hover:ring-brand-primary/60 flex-shrink-0"
                @click="navigateTo(localePath('/profile'))"
              >
                <img
                  :src="authStore.currentUser?.user_metadata?.avatarUrl || '/img/dummy-profile-img.jpg'"
