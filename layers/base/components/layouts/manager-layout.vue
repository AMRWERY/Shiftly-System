    ...
    <ul class="space-y-1">
      ...
      <li>
        <nuxt-link-locale
          ...
          class="sidebar-nav-link group"
          :class="
            isActive('/quick-access-contacts')
              ? 'sidebar-link-active'
              : 'sidebar-link-hover text-tx-primary'
          "
        >
          <Icon
            name="material-symbols:contacts-rounded"
            class="sidebar-section-icon"
            :class="
              isActive('/quick-access-contacts')
                ? 'text-brand-primary dark:text-white'
