<template>
  <div>
    <ul class="space-y-3">
      <li>
        <button
          @click="toggleDropdown('compliance_overview')"
          type="button"
        ...
        >
          ...
          <icon
            ...
            class="w-5 h-5"
            :class="{ 'rotate-180': dropdownStates.compliance_overview }"
            aria-hidden="true"
          />
        </button>
      ...
      <li>
        <button
          @click="toggleDropdown('audit_logs')"
          type="button"
          class="flex items-center w-full p-2 text-base text-white transition duration-75 rounded-lg group"
        >
          <icon
          ...
          <icon
            name="material-symbols:keyboard-arrow-down-rounded"
            class="w-5 h-5"
            :class="{ 'rotate-180': dropdownStates.audit_logs }"
            aria-hidden="true"
          />
        </button>
      ...
      <li>
        <button
          @click="toggleDropdown('payroll_finance_review')"
          type="button"
          class="flex items-center w-full p-2 text-base text-white transition duration-75 rounded-lg group"
        >
          <icon
          ...
          <icon
            name="material-symbols:keyboard-arrow-down-rounded"
            class="w-5 h-5"
            :class="{ 'rotate-180': dropdownStates.payroll_finance_review }"
            aria-hidden="true"
          />
        </button>
      ...
      <li>
        <button
          @click="toggleDropdown('inventory_audit')"
          type="button"
          class="flex items-center w-full p-2 text-base text-white transition duration-75 rounded-lg group"
        >
          <icon
          ...
          <icon
            name="material-symbols:keyboard-arrow-down-rounded"
            class="w-5 h-5"
            :class="{ 'rotate-180': dropdownStates.inventory_audit }"
            aria-hidden="true"
          />
        </button>
