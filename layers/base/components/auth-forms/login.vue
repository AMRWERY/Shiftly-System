  ...
  <div>
    <div class="w-full text-slate-200 space-y-6">
      ...
      <div class="text-center">
        <h2 class="text-2xl font-bold text-tx-primary">
          {{ t("form.welcome_back") }}
        </h2>
        <p class="text-tx-secondary mt-1 text-sm">
          {{ t("form.sign_in_to_workspace") }}
        </p>
      </div>
      ...
      <LazyVFormWrapper @submit="handleLogin" class="space-y-4">
        ...
        <LazyVInput
          ...
          prefix-icon="ph:envelope-simple"
          ...
          >
            ...
            >
              ...
              <Icon
                ...
                class="w-4 h-4 text-indigo-400 animate-pulse"
              />
            </div>
            ...
            >
              ...
              />
              <Icon
                v-else-if="isUnlocked || dragPercentage >= 85"
      ...
      <div class="text-center space-y-3 pt-1">
        <div
          class="flex items-center justify-center gap-1.5 text-[9px] text-slate-600 tracking-widest"
        >
        ...
        <div class="flex justify-center gap-5 text-[11px] text-slate-500">
          <nuxt-link-locale
            ...
            >{{ t("meta.privacy_policy") }}</nuxt-link-locale
          >
          <nuxt-link-locale
            to="/terms-of-service"
            class="hover:text-slate-300 transition-colors"
